...
const dbPath = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), 'budget.db');
const db = (0, __TURBOPACK__imported__module__$5b$externals$5d2f40$libsql$2f$client__$5b$external$5d$__$2840$libsql$2f$client$2c$__esm_import$29$__["createClient"])({
    url: `file:${dbPath}`
});
...
async function GET() {
    try {
        const txRes = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].execute('SELECT * FROM transactions ORDER BY date DESC');
        const transactions = txRes.rows;
        const catRes = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].execute('SELECT name FROM categories');
        const categories = catRes.rows.map((row)=>row.name);
        const dbRes = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].execute({
            sql: 'SELECT value FROM settings WHERE key = ?',
            args: [
                'defaultBudget'
            ]
        });
        const defaultBudget = dbRes.rows.length > 0 ? parseInt(dbRes.rows[0].value, 10) : 0;
        const mbRes = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].execute("SELECT * FROM settings WHERE key LIKE 'budget_%'");
        const monthlyBudgets = mbRes.rows.map((b)=>({
                month: b.key.replace('budget_', ''),
...
async function POST(req) {
    try {
        ...
        if (statements.length > 0) {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].batch(statements, 'write');
        }
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c0ae5780._.js.map